...
.language-picker{align-self:flex-end;display:flex;align-items:center;gap:.4rem;margin-bottom:1rem;color:#6f6a77;font-size:.68rem}.language-picker select{padding:.35rem 1.7rem .35rem .5rem;border:1px solid #dedbe5;border-radius:7px;background-color:#fff;color:#3e3945;font-size:.68rem}
