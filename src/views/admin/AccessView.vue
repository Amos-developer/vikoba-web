...
const actionLabel = (action) => ({ loan_disbursement: "Loan disbursement", withdrawal: "Withdrawal", expense: "Expense", penalty_waiver: "Penalty waiver", social_fund_disbursement: "Social-fund support", social_fund_contribution: "Social-fund contribution", shareout_payment: "Share-out payment" }[action] || action);
